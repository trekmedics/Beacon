...
help_message = 'invalid_response'
location     = 'invalid_response'
...
# Create incident
  res = Net::HTTP.post_form(uri, 'To' => beacon_number, 'From' => rp_phone_number, 'Body' => help_message)
  res = Net::HTTP.post_form(uri, 'To' => beacon_number, 'From' => rp_phone_number, 'Body' => location)
...
# Some respond promptly
  ...
  res = Net::HTTP.post_form(uri, 'To' => beacon_number, 'From' => frs[1].phone_number, 'Body' => incident.id.to_s + '.10 1')
...
test_label = 'invalid_response'
if incident.state == 'incident_complete' && incident.completion_status == 'fr_cancel'
