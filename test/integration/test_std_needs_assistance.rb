...
help_message = 'needs_assistance'
location     = 'needs_assistance'
...
# Expire Assistance Request window manually
  ...
  # Needs assistance then arrives at hospital
  IncomingMessageService.process_message(frs[1].phone_number, '2')
  IncomingMessageService.process_message(frs[1].phone_number, '1')
