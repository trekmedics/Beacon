...
help_message = 'no_vehicles'
location     = 'no_vehicles'
...
#   IncomingMessageService.process_message(frs[7].phone_number,'123')
  ...
  IncomingMessageService.process_message(frs[2].phone_number, '2')
  IncomingMessageService.process_message(frs[3].phone_number, '2')
...
#   end
  ...
  test_label = 'no_vehicles'
if incident.state == 'incident_complete' && incident.completion_status == 'no_addl_resources'
